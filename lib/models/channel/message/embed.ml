...
type provider =
  {name: string option [@default None]; url: string option [@default None]}
[@@deriving sexp, yojson {strict= false; exn= true}]
...
type field = {name: string; value: string; inline: bool [@default false]}
[@@deriving sexp, yojson {strict= false; exn= true}]
...
let default_footer = {text= ""; icon_url= None; proxy_icon_url= None}

let default_image = {url= None; proxy_url= None; height= None; width= None}

let default_video = {url= None; width= None; height= None}

let default_provider = {name= None; url= None}

let default_author =
  {name= None; url= None; icon_url= None; proxy_icon_url= None}
...
let field (name, value, inline) e =
  {e with fields= {name; value; inline} :: e.fields}

let fields l e =
  { e with
    fields= List.map ~f:(fun (name, value, inline) -> {name; value; inline}) l
  }
