...
val start :
  ?count:int -> ?compress:bool -> ?large_threshold:int -> unit -> t Deferred.t
...
module Shard : sig
  ...
  val heartbeat : shard -> shard Deferred.t
  ...
  val shutdown : ?clean:bool -> ?restart:bool -> shard t -> unit Deferred.t
end
...
val shutdown_all : ?restart:bool -> t -> unit list Deferred.t
